...
function App() {
  ...
  return (
    <>
      ...
      {page === 2 && <Trivia topic={topic} intervalTime={3} goToNextPage={() => {setPage(3)}} questions={Questions} setQuestionInfo={setQuestions} questionTime={30} numberOfQuestions={3} logo={Logo}/>}
